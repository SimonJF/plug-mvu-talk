...
\usepackage{graphicx}
\usepackage{xspace}
\usepackage{dirtytalk} \usepackage{xparse}% http://ctan.org/pkg/xparse \usepackage{etoolbox}% http://ctan.org/pkg/etoolbox
...
{\small\[\begin{array}{@{}lr@{\:\:\:}c@{\:\:\:}l}\ignorespaces}
{\end{array}\]\ignorespacesafterend}

\newcommand{\mvu}{\ensuremath{\mathsf{MVU}}\xspace}
\newcommand{\antiquote}[1]{\mathbf{\{} #1 \mathbf{\}}}
\newcommand{\htmlty}[1]{\mkwd{HTML}(#1)}
\newcommand{\attrty}[1]{\mkwd{Attr}(#1)}
\newcommand{\attr}[2]{\text{#1}=#2}
\newcommand{\tagname}[1]{\mathtt{#1}}
\newcommand{\htmltag}[3]{{<} \tagname{#1} \: #2 {>} #3 {<} / \tagname{#1}{>}}
\newcommand{\htmltagonly}[2]{{<} \tagname{#1} {>} #2 {<} / \tagname{#1}{>}}
\newcommand{\opentag}[2]{{<} \tagname{#1} \: #2 {>}}
\newcommand{\closetag}[2]{{<} / \tagname{#1} \: #2 {>}}
\newcommand{\ot}[1]{{<} \tagname{#1} {>}}
\newcommand{\ct}[1]{{<} / \tagname{#1}{>}}
\newcommand{\htmlterm}[1]{\calcwd{html} \app #1}
\newcommand{\evtty}[1]{\mkwd{ty}(#1)}

\newcommand{\clickevt}[1]{\mkwd{click}_{#1}}
\newcommand{\keydownevt}[2]{\mkwd{keyDown}_{#1, #2}}
\newcommand{\keyupevt}[2]{\mkwd{keyUp}_{#1, #2}}
\newcommand{\inputevt}[2]{\mkwd{input}_{#1, #2}}
\newcommand{\vh}{V_{\textsf{H}}\xspace}
\newcommand{\va}{V_{\textsf{a}}\xspace}


\newcommand{\handlerproc}[5]{\langle #1 \mid #2 \mid #3 \mid #4 \mid #5 \rangle}
\newcommand{\idle}{\calcwd{idle}\xspace}
\newcommand{\sys}[4]{#1 ;\: #2 ;\: #3 ;\: #4}
\newcommand{\evthandler}[1]{\texttt{#1}}
...
\newcommand{\vdashs}{\vdash_{\textsf{S}}}
...
\usepackage{soul}
\newcommand{\hlred}[1]{\hl{#1}}
%\DeclareRobustCommand{\hlred}[1]{{\sethlcolor{colorpink}\hl{#1}}}
